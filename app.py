...
VERSION = "25.1.0-preview-hardening"
...
PLATFORM_HOSTS = {"youtube.com", "www.youtube.com", "m.youtube.com", "youtu.be", "youtube-nocookie.com", "www.youtube-nocookie.com"}
MAX_URL_REDIRECTS = 5
MAX_URL_HEADER_BYTES = 1024 * 1024
...
def _validate_public_url(value: str) -> str:
    ...
    if _host_is_platform(parsed.hostname):
        raise HTTPException(400, "Platform links are not enabled in this phase. Use a direct public video file URL.")
...
def runtime_diagnostics() -> dict[str, Any]:
    return {
        ...
        "input_mode": "uploaded files + direct public video URLs",
...
async def import_url(
    ...
    try:
        source, filename = await asyncio.to_thread(_acquire_public_video, job_id, url)
