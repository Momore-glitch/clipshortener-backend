...
VERSION = "26.0.0-platform-acquisition"
...
def _acquire_cobalt_video(job_id: str, url: str) -> tuple[Path, str]:
    ...
    if download_parsed.scheme not in {"http", "https"} or not download_parsed.hostname or not _host_is_public(download_parsed.hostname):
