...
FFMPEG_TUNE = os.getenv("CLIPSHORTENER_FFMPEG_TUNE", "fastdecode").strip() or "fastdecode"
FFMPEG_X264_PARAMS = os.getenv(
    ...
    if captions_enabled:
        ...
        try:
            ...
            cmd = [
                ...
                "-c:v", "libx264", "-preset", FFMPEG_PRESET, "-tune", FFMPEG_TUNE,
                "-x264-params", FFMPEG_X264_PARAMS,
