...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    CLIPSHORTENER_FFMPEG_TUNE=fastdecode \
    CLIPSHORTENER_X264_PARAMS="ref=1:bframes=0:me=dia:subme=0:trellis=0:rc-lookahead=0:sync-lookahead=0:mbtree=0:weightp=0:weightb=0" \
